...
The four findings that are not decided. Everything else in this file is resolved and kept — see the
note above the resolved section for why.
...
# Resolved — the reasoning the code points at
