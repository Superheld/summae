...
| NF-021 asset disposal never writes off the carrying amount | **OPEN** (2026-08-16) — `asset-service.ts` `dispose` books only the proceeds; the asset account keeps the carrying amount. F-AST-004. Write-up on the PHP side |
