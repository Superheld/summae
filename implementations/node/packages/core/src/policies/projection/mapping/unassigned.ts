...
/**
 * Label for the catch-all. Neutral and jurisdiction-free on purpose: there is no mapping entry to
 * take a label from, and the core carries no statute language (see the no-jurisdiction-text guard).
 */
